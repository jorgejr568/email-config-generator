<p>Abra o <b>Mozilla Thunderbird</b> em "<b>Ferramentas</b>" >> "<b>Configurar contas...</b>".
    ...
    <?php IMG("http://wiki.hostnet.com.br/images/3/3b/Tutorial-thunderbird-1.png");?>
</p><p>Na próxima tela você deve clicar em "<b>Ações de contas</b>" e depois em "<b>Nova conta de e-mail...</b>":<br /><br />
</p><p>
    <?php IMG("http://wiki.hostnet.com.br/images/a/a9/Thunderbird_12_1.png");?>
    ...
    <b>Endereço de email:</b> <?php echo $email;?> <br />
    ...
    imagestring($imagem, 2,161,92, $email, $preto);
...
<ul><li><b>Recebimento IMAP:</b>  mbox.<?php echo $email_explode[1];?> | <b>Porta:</b> 143 | <b>SSL:</b> Nenhuma
    </li></ul>
<ul><li><b>Envio SMTP:</b> smtp.<?php echo $email_explode[1];?> | <b>Porta:</b> 587 | <b>SSL:</b> Nenhuma
    </li></ul>
<ul><li><b>Nome de usuário:</b> <?php echo str_replace('@','=',$email);?>
    </li></ul>
<p><b>OBS</b> Caso tenha escolhido servidor POP3, no lugar de IMAP, será informado POP3, neste caso utilize a porta <b>110</b>. As demais informações são as mesmas.
    ...
    imagestring($imagem, 4,161,67, $nome_conta, $preto);
    imagestring($imagem, 2,161,92, $email, $preto);
    imagestring($imagem, 2,231,269, 'mbox.'.$email_explode[1], $preto);
    imagestring($imagem, 2,231,297, 'smtp.'.$email_explode[1], $preto);
    imagestring($imagem, 2,231,326, str_replace('@','=',$email), $preto);
    imagepng($imagem,PATH.'image_temp'.$i.$mail.'.png');
    imagedestroy($imagem);
    IMG(PATH."image_temp$i$mail.png");
    $i++
    ...
    imagestring($imagem, 3,357,127, 'mbox.'.$email_explode[1], $preto);
    imagestring($imagem, 3,310,176, 'smtp.'.$email_explode[1], $preto);
    imagepng($imagem,PATH.'image_temp'.$i.$mail.'.png');
    imagedestroy($imagem);
    IMG(PATH."image_temp$i$mail.png");
    $i++
