<p>Para configurar uma nova conta de e-mail no Microsoft Outlook 2010 clique em "<b>Arquivo</b>" >> "<b>Informações</b>" >> "<b>Adicionar conta</b>". <br /><br />
                            ...
                            <?php image("http://wiki.hostnet.com.br/images/2/21/Outlook10-1.png")?>
...
<p>Na próxima tela marque a opção de "<b>Configurar manualmente as definições do servidor ou tipos de servidor adicionais</b>".<br /><br />
                            ...
                            <?php image("http://wiki.hostnet.com.br/images/7/7b/Outlook10-2.png")?>

<p>Agora escolha o "Serviço" marcando a opção "<b>Email da Internet</b>".<br /><br />
</p><p>Depois clique em "<b>Avançar</b>".<br /><br />
</p>
                            <?php image("http://wiki.hostnet.com.br/images/8/89/Outlook10-3.png")?>
...
<ul><li> <b>Nome</b>:  Seu nome
    </li><li> <b>Endereço de Email</b>: <?php echo EMAIL_CLI;?><br /><br />
    </li></ul>
...
<ul><li> <b>Tipo de conta</b>:  Escolha a opção <b>IMAP</b> ou <b>POP3</b>. Recomendamos que escolha <b>IMAP</b> caso não tenha uma preferência.
    </li><li> <b>Servidor de entrada de emails</b>:  <b>mbox.<?php echo DOMINIO_CLI;?></b>
    </li><li> <b>Servidor de saída de emails (SMTP)</b>:  <b>smtp.<?php echo DOMINIO_CLI;?></b><br /><br />
    </li></ul>
...
imagestring($imagem, 2,210,160, EMAIL_CLI, $preto);
imagestring($imagem, 2,210,233, 'mbox.'.DOMINIO_CLI, $preto);
imagestring($imagem, 2,210,258, 'smtp.'.DOMINIO_CLI, $preto);
imagestring($imagem, 2,210,306,USUARIO_CONTA, $preto);
...
<p>Em "Mais configurações", clique na aba "<b>Servidor de Saída</b>".<br />
                            ...
                            <?php image("http://wiki.hostnet.com.br/images/9/9d/Outlook10-5.png")?>
